...
public class ShiftToMiddleArrayBenchmark {
    ...
    public static void runBenchmark(int operations) {
        int[] testSizes = {0, 10, 50, 100, 500, 1000};
        int runs = 20; // Number of runs to average

        try (FileWriter writer = new FileWriter("benchmark_results_list_java.csv")) {
            ...
            for (int size : testSizes) {
                ...
                for (int i = 0; i < runs; i++) {
                    arrayListTotal += benchmarkRandomOperations(new ArrayList<>(10), size, operations);
                    linkedListTotal += benchmarkRandomOperations(new LinkedList<>(), size, operations);
                ...
                System.out.println("ArrayList (avg over " + runs + " runs): " + arrayListAvg + " ms");

                System.out.println("Benchmarking LinkedList...");
                System.out.println("LinkedList (avg over " + runs + " runs): " + linkedListAvg + " ms");
                ...
                writer.write(size + ",ArrayList," + arrayListAvg + "\n");
                writer.write(size + ",LinkedList," + linkedListAvg + "\n");
                writer.write(size + ",ShiftToMiddleArray," + stmAvg + "\n");
            }

            System.out.println("Results saved to benchmark_results_list_java.csv");
